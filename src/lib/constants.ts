...
export const TRANSACTION_CATEGORIES = {
  income: [
    { value: 'salary', label: 'Gaji Bulanan', icon: '💵' },
    { value: 'freelance', label: 'Proyek / Freelance', icon: '💻' },
    { value: 'asprak', label: 'Asisten Praktikum', icon: '🎓' },
    { value: 'volunteer', label: 'Honor Kegiatan', icon: '🤝' },
    { value: 'investment', label: 'Hasil Investasi', icon: '📈' },
    { value: 'gift', label: 'Hadiah & Bonus', icon: '🎁' },
    { value: 'other_income', label: 'Pemasukan Lainnya', icon: '💰' },
  ],
  expense: [
    { value: 'food', label: 'Makanan & Minuman', icon: '🍽️' },
    { value: 'daily_needs', label: 'Kebutuhan Harian', icon: '🏪' },
    { value: 'shopping', label: 'Belanja Keperluan', icon: '🛍️' },
    { value: 'transport', label: 'Transportasi & Bensin', icon: '🚗' },
    { value: 'clothing', label: 'Pakaian & Fashion', icon: '👔' },
    { value: 'treatment', label: 'Perawatan Diri', icon: '✨' },
    { value: 'sedekah', label: 'Sedekah & Donasi', icon: '🤲' },
    { value: 'gift_giving', label: 'Hadiah / Kado', icon: '🎁' },
    { value: 'vacation', label: 'Liburan & Healing', icon: '✈️' },
    { value: 'entertainment', label: 'Hiburan & Relaksasi', icon: '🎟️' },
    { value: 'bills', label: 'Tagihan Rutin', icon: '📄' },
    { value: 'utilities', label: 'Listrik & Air', icon: '💡' },
    { value: 'internet', label: 'Kuota & Internet', icon: '📶' },
    { value: 'health', label: 'Kesehatan & Obat', icon: '🏥' },
    { value: 'vehicle', label: 'Perawatan Kendaraan', icon: '🔧' },
    { value: 'furniture', label: 'Perlengkapan Rumah', icon: '🛋️' },
    { value: 'education', label: 'Edukasi & Buku', icon: '📚' },
    { value: 'saving', label: 'Tabungan Masa Depan', icon: '🏦' },
    { value: 'ewallet', label: 'Top-up E-Wallet', icon: '📱' },
    { value: 'date', label: 'Agenda Berdua', icon: '🌹' },
    { value: 'other_expense', label: 'Pengeluaran Lainnya', icon: '💳' },
  ],
} as const
